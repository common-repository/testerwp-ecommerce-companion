<?php
if(get_theme_mod('eshopping_cart_disable_blog_list_sec',false) == true){
    return;
  }

$blog_list_cat  = get_theme_mod('eshopping_cart_blog_list_cat','');  
$countblog_list = get_theme_mod('eshopping_cart_countblog_list',3); 
?>
<section class="texture-product-list-section">
  <div class="container">
        <?php eshopping_cart_display_customizer_shortcut( 'eshopping_cart_product_slide_list' );?>

  <div class="section-title-heading text-center">
    <h2 class="heading"><?php echo esc_html(get_theme_mod('eshopping_cart_blog_list_heading','News & Blogs'));?></h2>
  </div>      
