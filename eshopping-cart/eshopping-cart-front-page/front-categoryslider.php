<?php
if(get_theme_mod('eshopping_cart_disable_category_slide_sec',false) == true){
    return;
  }
?>
...
<section class="texture-category-slide-section">
  ...
  <?php eshopping_cart_display_customizer_shortcut( 'eshopping_cart_cat_slide_section' );?>
  
  <div class="section-title-heading text-center">
    <h2 class="heading"><?php echo esc_html(get_theme_mod('eshopping_cart_cat_slider_heading','Woo Category'));?></h2>
  </div>

<div class="content-wrap">
<?php if(get_theme_mod('eshopping_cart_cat_slide_layout','cat-layout-1')=='cat-layout-1'):?>
<div class="texture-slide texture-cat-slide owl-carousel">
<?php   
  if( taxonomy_exists( 'product_cat' ) ){
      $term_id = get_theme_mod('eshopping_cart_category_slide_list'); 
      // category filter  
      $args = array(
 ...
 if($image){
    ...
    $image = esc_url(TESTERWP_CUSTOMIZER_PLUGIN_URL . 'eshopping-cart/assets/images/def-cat.png');
  }
...
<?php elseif(get_theme_mod('eshopping_cart_cat_slide_layout')=='cat-layout-2'):?>
...
<?php elseif(get_theme_mod('eshopping_cart_cat_slide_layout')=='cat-layout-3'):?>
...
<div class="cat-col-wrap">
  <img src="'.esc_url($image).'">
        <div class="hover-area">
          ...
          <div class="prd-total-number"><span class="item">'.$product_category->count.esc_html('Product','eshopping-cart').'</span></div>
              </div>
