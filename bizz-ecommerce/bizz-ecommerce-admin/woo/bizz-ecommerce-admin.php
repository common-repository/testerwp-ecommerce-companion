...
if(!function_exists('bizz_ecommerce_product_query')){
    function bizz_ecommerce_product_query($term_id,$prdct_optn){
   $limit_product = get_theme_mod('bizz_ecommerce_prd_shw_no','20');
    // product filter
...
if(!function_exists('bizz_ecommerce_product_slide_list_loop')){
function bizz_ecommerce_product_slide_list_loop($term_id,$prdct_optn){
    $args = bizz_ecommerce_product_query($term_id,$prdct_optn);
   ...
   <?php };
      ...
      echo __( 'No products found','bizz-ecommerce' );
    }
    wp_reset_query();
 }
}
 ...
 **********************************************/   
if(!function_exists('bizz_ecommerce_category_tab_list')){
function bizz_ecommerce_category_tab_list( $term_id ){
...
/********************************/
if(!function_exists('bizz_ecommerce_product_cat_filter_default_loop')){
function bizz_ecommerce_product_cat_filter_default_loop($term_id,$prdct_optn){
    global $product;
    $args = bizz_ecommerce_product_query($term_id,$prdct_optn);
    $products = wc_get_products( $args );
    if (!empty($products)) {
        ...
        <div <?php post_class('product', $pid); ?>>
          ...
          <div class="texture-product">
               ...
               <div class="texture-product-hover">     
                    <?php 
                      echo bizz_ecommerce_add_to_cart_url($product);

                      if ( function_exists('bizz_ecommerce_whish_list_both')){
                      bizz_ecommerce_whish_list_both($pid);
                    }
                      if(get_theme_mod( 'bizz_ecommerce_woo_quickview_enable', true )){
                        $bizz_ecommerce_quickview_tooltip = esc_html(get_theme_mod( 'bizz_ecommerce_quickview_tooltip_txt' ));
                  ?>
                   <div class="texture-quickview" th-tooltip="<?php echo $bizz_ecommerce_quickview_tooltip; ?>">
                               <span class="quik-view">
                                   <a href="#" class="opn-quick-view-text" data-product_id="<?php echo esc_attr($pid); ?>">
                                      <span><?php _e('Quick View','bizz-ecommerce');?></span>
                                   </a>
                                </span>
                    </div>
                  <?php }
                  ...
                  bizz_ecommerce_add_to_compare_fltr_both($pid);
                }
...
if(!function_exists('bizz_ecommerce_product_filter_loop')){
function bizz_ecommerce_product_filter_loop($args){  
  global $product;
   $products = wc_get_products( $args );
    if (!empty($products)) {
    foreach ($products as $product) {
      ...
      if(count($attachment_ids) > '0'){
                $swapclasses='bizz-ecommerce-swap-item-hover';
        }
       }elseif('slide' === $hover_style){
       
      $attachment_ids = $product->get_gallery_image_ids();
      if(count($attachment_ids) > '0'){
                $swapclasses='bizz-ecommerce-slide-item-hover';
        }
       } else{
        $swapclasses='';
       }
...
/********************/
if(!function_exists('bizz_ecommerce_product_list_filter_loop')){
function bizz_ecommerce_product_list_filter_loop($args){  
    $products = wc_get_products( $args );
    if (!empty($products)) {
    foreach ($products as $product) {
      $pid =  $product->get_id();
...
if(! class_exists('Bizz_Ecommerce_List_Category_Images')){
class Bizz_Ecommerce_List_Category_Images extends Walker_Category {
