<?php
if(get_theme_mod('shopping_ecommerce_wp_disable_category_slide_sec',false) == true){
    return;
  }
?>
...
<section class="texture-category-slide-section">
  ...
  <?php shopping_ecommerce_wp_display_customizer_shortcut( 'shopping_ecommerce_wp_cat_slide_section' );?>
  
  <div class="section-title-heading text-center">
    <h2 class="heading"><?php echo esc_html(get_theme_mod('shopping_ecommerce_wp_cat_slider_heading','Woo Category'));?><span class="heading-2"><?php echo esc_html(get_theme_mod('shopping_ecommerce_wp_cat_slider_subheading','Sub Heading'));?></span></h2>
  </div>

<div class="content-wrap">
<?php if(get_theme_mod('shopping_ecommerce_wp_cat_slide_layout','cat-layout-1')=='cat-layout-1'):?>
<div class="texture-slide texture-cat-slide owl-carousel">
<?php   
  if( taxonomy_exists( 'product_cat' ) ){
      $term_id = get_theme_mod('shopping_ecommerce_wp_category_slide_list'); 
      // category filter  
      $args = array(
 ...
 if($image){
    ...
    $image = esc_url(TESTERWP_CUSTOMIZER_PLUGIN_URL . 'shopping-ecommerce-wp/assets/images/def-cat.png');
  }
...
<?php elseif(get_theme_mod('shopping_ecommerce_wp_cat_slide_layout')=='cat-layout-2'):?>
...
<?php elseif(get_theme_mod('shopping_ecommerce_wp_cat_slide_layout')=='cat-layout-3'):?>
...
<div class="cat-col-wrap">
  <img src="'.esc_url($image).'">
        <div class="hover-area">
          ...
          <div class="prd-total-number"><span class="item">'.$product_category->count.esc_html('Product','shopping-ecommerce-wp').'</span></div>
              </div>
